...
import foxit.task.SearchTask;
import foxit.task.TaskManager;
import foxit.view.IPageLayoutMode;
import foxit.view.PDFPagerAdapter;
import foxit.view.PDFViewPager;
import foxit.view.PageChangeListener;
...
public class ViewController implements IViewController
{
	...
	public void initPsi(){
		if (pagerAdapter == null) return;
		pagerAdapter.initPsi(viewPager.getCurrentItem());
	}
